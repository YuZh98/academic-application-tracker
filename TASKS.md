...
_Updated: 2026-04-21 (Phase 4 T1-D shipped on `feature/phase-4-tier1`; 239 tests green; next action: T1-E — fully-empty-DB hero callout per U5, with CTA button using `st.switch_page()` into Opportunities)_
