...
if df.empty:
    ...
    event = st.dataframe(
        ...
        column_config={
            ...
            # Issue #62: render link field as a clickable hyperlink.
            # Empty/NULL values display as empty cells automatically.
            "link": st.column_config.LinkColumn(
                "Link", display_text="\U0001f517 Open", width="small"
            ),
        },
        key="positions_table",
        on_select="rerun",
...
if "selected_position_id" in st.session_state:
    ...
    if not selected_row.empty:
        ...
        for req_col, done_col, _label in config.REQUIREMENT_DOCS:
            ...
            canonical[f"edit_{req_col}"] = v if v in config.REQUIREMENT_VALUES else "No"
